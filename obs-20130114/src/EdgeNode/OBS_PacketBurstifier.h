...
class OBS_PacketBurstifier : public omnetpp::cSimpleModule{
   protected:
	  //Main parameters:
      omnetpp::cQueue burstContent; //!< Packet queue.
   
      omnetpp::simtime_t timeout; //!< Burstifier's timeout. If reached, burst will be assembled with the current content of the queue.
      int maxSize; //!< Burst maximum size.
      int numPackets; //!< Maximum number of packets.
      omnetpp::simtime_t minOffset; //!< BCP's minimum offset.
      omnetpp::simtime_t maxOffset; //!< BCP's maximum offset.
      ...
      omnetpp::cMessage *timeout_msg; //!< Timeout message.

      //Statistics
      int burstCounter; //!< Created burst counter.
      omnetpp::cStdDev recvPackSize; //!< Received packets' length statistics.
      omnetpp::cOutVector recvPackSizeVec; //!< Length of the packets received (in bytes).
      omnetpp::cStdDev queuedTime; //!< Time between the first packet is queued and each of the packets are queued.
      omnetpp::cOutVector avgPacketTime; //!< Average packet delay due the burst assembly.

      omnetpp::simtime_t firstPacket_t; //!< Arrival time of the first packet for the current burst.
