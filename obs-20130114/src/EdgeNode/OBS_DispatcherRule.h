...
#include  "inet/networklayer/ipv4/Ipv4Header_m.h" // before was #include<IPDatagram_m.h>
//#include<Ipv4Datagram.h>
#include "inet/transportlayer/tcp_common/TcpHeader.h"//#include<TCPSegment.h>
#include "inet/transportlayer/tcp/Tcp.h"
#include "inet/transportlayer/udp/Udp.h"//#include<UDPPacket.h>
...
//      IPAddress destAddr; //!< Destination address (isSet[1]).
      inet::Ipv4Address srcAddr; //!< Source address (isSet[0]).
      inet::Ipv4Address destAddr; //!< Destination address (isSet[1]).
   ...
   public:
      ...
      bool match(omnetpp::cMessage *msg);
};
