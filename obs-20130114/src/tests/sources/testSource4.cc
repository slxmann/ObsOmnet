...
void testSource4::handleMessage(omnetpp::cMessage *msg){
...
void testSource4::processLine(){
	...
	omnetpp::simtime_t sendTime, BCPDelta, arrivalTime;
...
//				SourceControlInfo *info2 = info->dup();
				...
				omnetpp::cMsgPar *wrapper1 = new omnetpp::cMsgPar("SourceControlInfo");
				wrapper1->setPointerValue(info2);
				endBCP->setControlInfo(wrapper1);

				arrivalTime = omnetpp::SimTime::parse(arrivalTimeChr);
			    ...
			    omnetpp::cRuntimeError("Cannot send a BCP scheduled to the past");
			}
		}
}
