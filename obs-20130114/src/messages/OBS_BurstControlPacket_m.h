...
class OBS_BurstControlPacket;
/**
 * Class generated from <tt>src/messages/OBS_BurstControlPacket.msg:29</tt> by opp_msgtool.
 * <pre>
...
{
  protected:
    omnetpp::simtime_t burstArrivalDelta = -1;
    int burstColour = -1;
    int label = -1;
    int burstifierId = -1;
    int numSeq = -1;
  ...
  protected:
    bool operator==(const OBS_BurstControlPacket&) = delete;

  public:
    OBS_BurstControlPacket(const char *name=nullptr, short kind=0);
    ...
    virtual OBS_BurstControlPacket *dup() const override {return new OBS_BurstControlPacket(*this);}
...
template<> inline OBS_BurstControlPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<OBS_BurstControlPacket*>(ptr.get<cObject>()); }
