//
// Generated file, do not edit! Created by opp_msgtool 6.1 from inet/linklayer/ethernet/common/EthernetCommand.msg.
//
...
EthernetBindCommand::EthernetBindCommand() : ::inet::SocketBindCommand()
{
}

EthernetBindCommand::EthernetBindCommand(const EthernetBindCommand& other) : ::inet::SocketBindCommand(other)
{
    copy(other);
}
...
const MacAddress& EthernetBindCommand::getLocalAddress() const
{
    return this->localAddress;
}

void EthernetBindCommand::setLocalAddress(const MacAddress& localAddress)
{
    this->localAddress = localAddress;
}

const MacAddress& EthernetBindCommand::getRemoteAddress() const
{
    return this->remoteAddress;
}

void EthernetBindCommand::setRemoteAddress(const MacAddress& remoteAddress)
{
...
void EthernetBindCommand::setProtocol(const Protocol * protocol)
{
...
EthernetBindCommandDescriptor::EthernetBindCommandDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::EthernetBindCommand)), "inet::SocketBindCommand")
{
...
int EthernetBindCommandDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "localAddress") == 0) return baseIndex + 0;
...
const char *EthernetBindCommandDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::MacAddress",    // FIELD_localAddress
        "inet::MacAddress",    // FIELD_remoteAddress
