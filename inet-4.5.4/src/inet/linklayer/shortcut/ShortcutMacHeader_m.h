...
/**
 * Class generated from <tt>inet/linklayer/shortcut/ShortcutMacHeader.msg:14</tt> by opp_msgtool.
 * <pre>
...
class INET_API ShortcutMacHeader : public ::inet::FieldsChunk
{
  ...
  protected:
    bool operator==(const ShortcutMacHeader&) = delete;
...
template<> inline inet::ShortcutMacHeader *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::ShortcutMacHeader*>(ptr.get<cObject>()); }
