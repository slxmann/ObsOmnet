...
std::string GpsrOptionDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_perimeterRoutingStartPosition: return pp->getPerimeterRoutingStartPosition().str();
        case FIELD_perimeterRoutingForwardPosition: return pp->getPerimeterRoutingForwardPosition().str();
