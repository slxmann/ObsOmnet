//
// Generated file, do not edit! Created by opp_msgtool 6.1 from inet/physicallayer/wireless/common/base/packetlevel/TransmissionBase.msg.
//
...
std::string TransmissionBaseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_startPosition: return pp->getStartPosition().str();
        case FIELD_startOrientation: return "";
        case FIELD_endTime: return simtime2string(pp->getEndTime());
        case FIELD_endPosition: return pp->getEndPosition().str();
