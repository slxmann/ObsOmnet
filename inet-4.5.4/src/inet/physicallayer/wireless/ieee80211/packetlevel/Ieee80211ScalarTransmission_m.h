...
#include "inet/physicallayer/wireless/common/analogmodel/packetlevel/ScalarTransmission_m.h" // import inet.physicallayer.wireless.common.analogmodel.packetlevel.ScalarTransmission
