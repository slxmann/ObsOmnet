//
// Generated file, do not edit! Created by opp_msgtool 6.1 from inet/common/FlowTag.msg.
//
...
{
    if (k >= names_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)names_arraysize, (unsigned long)k);
...
void FlowTag::appendNames(const char * names)
{
...
int FlowTagDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "names") == 0) return baseIndex + 0;
...
int FlowTagDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    FlowTag *pp = omnetpp::fromAnyPtr<FlowTag>(object); (void)pp;
    switch (field) {
...
void FlowTagDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *FlowTagDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string FlowTagDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FlowTagDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::cValue FlowTagDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    FlowTag *pp = omnetpp::fromAnyPtr<FlowTag>(object); (void)pp;
    switch (field) {
        case FIELD_names: return pp->getNames(i);
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'FlowTag' as cValue -- field index out of range?", field);
    }
}

void FlowTagDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    FlowTag *pp = omnetpp::fromAnyPtr<FlowTag>(object); (void)pp;
    switch (field) {
        case FIELD_names: pp->setNames(i,value.stringValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FlowTag'", field);
    }
}
...
omnetpp::any_ptr FlowTagDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FlowTagDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
