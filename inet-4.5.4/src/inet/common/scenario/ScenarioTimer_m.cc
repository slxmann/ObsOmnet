...
ScenarioTimer::ScenarioTimer(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

ScenarioTimer::ScenarioTimer(const ScenarioTimer& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
ScenarioTimer& ScenarioTimer::operator=(const ScenarioTimer& other)
{
...
void ScenarioTimer::copy(const ScenarioTimer& other)
{
    this->xmlNode = other.xmlNode;
}

void ScenarioTimer::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->xmlNode);
}

void ScenarioTimer::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
class ScenarioTimerDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    ScenarioTimerDescriptor();
    virtual ~ScenarioTimerDescriptor();
...
{
    return dynamic_cast<ScenarioTimer *>(obj)!=nullptr;
}
