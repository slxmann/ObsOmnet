//
// Generated file, do not edit! Created by opp_msgtool 6.1 from inet/common/packet/chunk/Chunk.msg.
//
...
class StreamBufferChunkDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertyNames;
    enum FieldConstants {
  ...
  public:
    StreamBufferChunkDescriptor();
    virtual ~StreamBufferChunkDescriptor();
...
Register_ClassDescriptor(StreamBufferChunkDescriptor)

StreamBufferChunkDescriptor::StreamBufferChunkDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::StreamBufferChunk)), "inet::Chunk")
{
    propertyNames = nullptr;
}

StreamBufferChunkDescriptor::~StreamBufferChunkDescriptor()
{
    delete[] propertyNames;
}

bool StreamBufferChunkDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<StreamBufferChunk *>(obj)!=nullptr;
}

const char **StreamBufferChunkDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
        static const char *names[] = { "existingClass", "descriptor",  nullptr };
        omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
const char *StreamBufferChunkDescriptor::getProperty(const char *propertyName) const
{
    if (!strcmp(propertyName, "existingClass")) return "";
    if (!strcmp(propertyName, "descriptor")) return "readonly";
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
int StreamBufferChunkDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 3+base->getFieldCount() : 3;
}

unsigned int StreamBufferChunkDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    static unsigned int fieldTypeFlags[] = {
        0,    // FIELD_startTime
        0,    // FIELD_datarate
        FD_ISCOMPOUND | FD_ISPOINTER | FD_ISCOBJECT,    // FIELD_streamData
    };
    return (field >= 0 && field < 3) ? fieldTypeFlags[field] : 0;
}

const char *StreamBufferChunkDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int StreamBufferChunkDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    int baseIndex = base ? base->getFieldCount() : 0;
    if (strcmp(fieldName, "startTime") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "datarate") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "streamData") == 0) return baseIndex + 2;
    return base ? base->findField(fieldName) : -1;
}

const char *StreamBufferChunkDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::Chunk",    // FIELD_streamData
    };
    return (field >= 0 && field < 3) ? fieldTypeStrings[field] : nullptr;
}

const char **StreamBufferChunkDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *StreamBufferChunkDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        case FIELD_streamData:
            if (!strcmp(propertyName, "getter")) return "_getStreamData";
            return nullptr;
        default: return nullptr;
    }
}

int StreamBufferChunkDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    StreamBufferChunk *pp = omnetpp::fromAnyPtr<StreamBufferChunk>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void StreamBufferChunkDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    StreamBufferChunk *pp = omnetpp::fromAnyPtr<StreamBufferChunk>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'StreamBufferChunk'", field);
    }
}

const char *StreamBufferChunkDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    StreamBufferChunk *pp = omnetpp::fromAnyPtr<StreamBufferChunk>(object); (void)pp;
    switch (field) {
        case FIELD_streamData: { const Chunk * value = pp->_getStreamData(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}

std::string StreamBufferChunkDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_streamData: { auto obj = pp->_getStreamData(); return obj == nullptr ? "" : obj->str(); }
        default: return "";
    }
}

void StreamBufferChunkDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    StreamBufferChunk *pp = omnetpp::fromAnyPtr<StreamBufferChunk>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'StreamBufferChunk'", field);
    }
}

omnetpp::cValue StreamBufferChunkDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_streamData: return omnetpp::toAnyPtr(pp->_getStreamData()); break;
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'StreamBufferChunk' as cValue -- field index out of range?", field);
    }
}

void StreamBufferChunkDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *StreamBufferChunkDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        case FIELD_streamData: return omnetpp::opp_typename(typeid(Chunk));
        default: return nullptr;
    };
}

omnetpp::any_ptr StreamBufferChunkDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void StreamBufferChunkDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
