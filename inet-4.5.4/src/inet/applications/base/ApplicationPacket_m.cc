...
ApplicationPacket::ApplicationPacket() : ::inet::FieldsChunk()
{
}

ApplicationPacket::ApplicationPacket(const ApplicationPacket& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
uint32_t ApplicationPacket::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void ApplicationPacket::setSequenceNumber(uint32_t sequenceNumber)
{
    handleChange();
...
ApplicationPacketDescriptor::ApplicationPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ApplicationPacket)), "inet::FieldsChunk")
{
