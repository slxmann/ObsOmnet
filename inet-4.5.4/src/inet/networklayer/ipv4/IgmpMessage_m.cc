//
// Generated file, do not edit! Created by opp_msgtool 6.1 from inet/networklayer/ipv4/IgmpMessage.msg.
//
...
Register_Enum(inet::IgmpTimerKind, (inet::IgmpTimerKind::IGMP_QUERY_TIMER, inet::IgmpTimerKind::IGMP_HOSTGROUP_TIMER, inet::IgmpTimerKind::IGMP_LEAVE_TIMER, inet::IgmpTimerKind::IGMP_REXMT_TIMER));
